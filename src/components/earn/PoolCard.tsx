...
export default function PoolCard({ stakingInfo }: { stakingInfo: StakingInfo }) {
  ...
  return (
    <Wrapper showBackground={isStaking} bgColor={backgroundColor}>
      ...
      <TopSection>
        ...
        <StyledInternalLink to={`/uni/${currencyId(currency0)}/${currencyId(currency1)}`} style={{ width: '100%' }}>
          <ButtonPrimary padding="8px" borderRadius="8px">
            {isStaking ? t('earn.PoolCard.Manage') : t('earn.PoolCard.Deposit')}
          </ButtonPrimary>
        </StyledInternalLink>
      </TopSection>
      ...
      <StatContainer>
        <RowBetween>
          <TYPE.white> {t('earn.PoolCard.TotalDeposited')}</TYPE.white>
          <TYPE.white>
        ...
        <RowBetween>
          <TYPE.white> {t('earn.PoolCard.PoolRate')}</TYPE.white>
          <TYPE.white>
            {stakingInfo
              ? stakingInfo.active
        ...
        <>
          ...
          <BottomSection showBackground={true}>
            <TYPE.black color={'white'} fontWeight={500}>
              <span>{t('earn.PoolCard.YourRate')}</span>
            </TYPE.black>
