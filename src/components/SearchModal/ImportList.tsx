    ...
    <Wrapper>
      <PaddedColumn gap="14px" style={{ width: '100%', flex: '1 1' }}>
        <RowBetween>
          ...
          <TYPE.mediumHeader>{t('SearchModal.ImportList.ImportList')}</TYPE.mediumHeader>
      ...
      <PaddedColumn gap="md">
        <AutoColumn gap="md">
          ...
          <Card style={{ backgroundColor: transparentize(0.8, theme.red1) }}>
            <AutoColumn justify="center" style={{ textAlign: 'center', gap: '16px', marginBottom: '12px' }}>
              ...
              <TYPE.body fontWeight={500} fontSize={20} color={theme.red1}>
               {t('SearchModal.ImportList.ImportRisk')}{' '}
              </TYPE.body>
            </AutoColumn>

            <AutoColumn style={{ textAlign: 'center', gap: '16px', marginBottom: '12px' }}>
              <TYPE.body fontWeight={500} color={theme.red1}>
                {t('SearchModal.ImportList.ByImplicitly')}
              </TYPE.body>
              <TYPE.body fontWeight={600} color={theme.red1}>
                {t('SearchModal.ImportList.PurchaseBack')}
              </TYPE.body>
            </AutoColumn>
            <AutoRow justify="center" style={{ cursor: 'pointer' }} onClick={() => setConfirmed(!confirmed)}>
              ...
              <TYPE.body ml="10px" fontSize="16px" color={theme.red1} fontWeight={500}>
               {t('SearchModal.ImportList.Understand')}
              </TYPE.body>
            </AutoRow>
          </Card>
          ...
          >
            {t('SearchModal.ImportList.Import')}
          </ButtonPrimary>
          {addError ? (
