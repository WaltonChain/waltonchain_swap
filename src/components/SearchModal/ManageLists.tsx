          ...
          <StyledMenu ref={node as any}>
            ...
            {open && (
              <PopoverContainer show={true} ref={setPopperElement as any} style={styles.popper} {...attributes.popper}>
                ...
                <SeparatorDark />
                <ExternalLink href={`https://tokenlists.org/token-list?url=${listUrl}`}>{t('SearchModal.ManageLists.ViewList')}</ExternalLink>
                <UnpaddedLinkStyledButton onClick={handleRemoveList} disabled={Object.keys(listsByUrl).length === 1}>
                  {t('SearchModal.ManageLists.RemoveList')}
                </UnpaddedLinkStyledButton>
                {pending && (
                  <UnpaddedLinkStyledButton onClick={handleAcceptListUpdate}>{t('SearchModal.ManageLists.UpdateList')}</UnpaddedLinkStyledButton>
                )}
              </PopoverContainer>
            )}
          </StyledMenu>
            ...
            <RowBetween>
              ...
              {isImported ? (
                <RowFixed>
                  ...
                  <TYPE.body color={theme.text2}>{t('SearchModal.ManageLists.Loaded')}</TYPE.body>
                </RowFixed>
              ) : (
                <ButtonPrimary
                  style={{ fontSize: '14px' }}
                ...
                >
                  {t('SearchModal.ManageLists.Import')}
                </ButtonPrimary>
              )}
            </RowBetween>
          </Card>
