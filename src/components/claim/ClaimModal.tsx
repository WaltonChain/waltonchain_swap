      ...
      {!attempting && !claimConfirmed && (
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              <RowBetween>
                <TYPE.white fontWeight={500}>{t('claim.ClaimUNI')}</TYPE.white>
            ...
            <CardSection gap="sm">
              ...
              {userClaimData?.flags?.isLP &&
                ...
                JSBI.greaterThanOrEqual(unclaimedAmount.raw, nonLPAmount) && (
                  <RowBetween>
                    <TYPE.subHeader color="white">{t('claim.Liquidity')}</TYPE.subHeader>
              ...
              {userClaimData?.flags?.isUser && (
                <RowBetween>
                  <TYPE.subHeader color="white">{t('claim.User')}</TYPE.subHeader>
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              {t('claim.CommunityGovernance')}<br /> <br />
              <ExternalLink href="https://Waltonchain-swap.org/blog/uni">{t('claim.ReadMore')}</ExternalLink>
            </TYPE.subHeader>
            <ButtonPrimary
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <AutoColumn gap="100px" justify={'center'}>
            ...
            {attempting && !claimSubmitted && (
              <TYPE.subHeader color="black">{t('claim.ConfirmWallet')}</TYPE.subHeader>
            )}
